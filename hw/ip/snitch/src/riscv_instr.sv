...
package riscv_instr;
  ...
  localparam logic [31:0] P_LB_IRPOST        = 32'b?????????????????000?????1011111;
  localparam logic [31:0] P_LBU_IRPOST       = 32'b?????????????????100?????1011111;
  localparam logic [31:0] P_LH_IRPOST        = 32'b?????????????????001?????1011111;
  localparam logic [31:0] P_LHU_IRPOST       = 32'b?????????????????101?????1011111;
  localparam logic [31:0] P_LW_IRPOST        = 32'b?????????????????010?????1011111;
  localparam logic [31:0] P_LB_RRPOST        = 32'b0000000??????????111?????1011111;
  localparam logic [31:0] P_LBU_RRPOST       = 32'b0100000??????????111?????1011111;
  localparam logic [31:0] P_LH_RRPOST        = 32'b0001000??????????111?????1011111;
  localparam logic [31:0] P_LHU_RRPOST       = 32'b0101000??????????111?????1011111;
  localparam logic [31:0] P_LW_RRPOST        = 32'b0010000??????????111?????1011111;
  ...
  localparam logic [31:0] P_SB_IRPOST        = 32'b?????????????????000?????0011111;
  localparam logic [31:0] P_SH_IRPOST        = 32'b?????????????????001?????0011111;
  localparam logic [31:0] P_SW_IRPOST        = 32'b?????????????????010?????0011111;
  localparam logic [31:0] P_SB_RRPOST        = 32'b0000000??????????100?????0011111;
  localparam logic [31:0] P_SH_RRPOST        = 32'b0000000??????????101?????0011111;
  localparam logic [31:0] P_SW_RRPOST        = 32'b0000000??????????110?????0011111;
  ...
  localparam logic [31:0] LP_STARTI          = 32'b????????????000000000000?1110111;
  localparam logic [31:0] LP_ENDI            = 32'b????????????000000010000?1110111;
  localparam logic [31:0] LP_COUNT           = 32'b000000000000?????0100000?1110111;
  localparam logic [31:0] LP_COUNTI          = 32'b????????????000000110000?1110111;
  localparam logic [31:0] LP_SETUP           = 32'b?????????????????1000000?1110111;
  localparam logic [31:0] LP_SETUPI          = 32'b?????????????????1010000?1110111;
