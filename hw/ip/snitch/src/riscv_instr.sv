...
package riscv_instr;
  ...
  localparam logic [31:0] SCFGRI             = 32'b????????????00000001?????0001011;
  localparam logic [31:0] SCFGWI             = 32'b?????????????????010000000001011;
  localparam logic [31:0] SCFGR              = 32'b0000000?????00001001?????0001011;
  localparam logic [31:0] SCFGW              = 32'b0000000??????????010000010001011;
  localparam logic [31:0] FREP_O             = 32'b????????????????????????11101011;
  localparam logic [31:0] FREP_I             = 32'b????????????????????????01101011;
  ...
  localparam logic [31:0] P_LH_IRPOST        = 32'b?????????????????011?????0001011;
  localparam logic [31:0] P_LHU_IRPOST       = 32'b?????????????????101?????0001011;
  localparam logic [31:0] P_LW_IRPOST        = 32'b?????????????????110?????0001011;
