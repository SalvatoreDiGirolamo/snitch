...
package snitch_pkg;
  ...
  function automatic string print_snitch_trace(snitch_trace_port_t snitch_trace);
    ...
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "uses_rd", snitch_trace.uses_rd);
    ...
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "gpr_rdata_0", snitch_trace.gpr_rdata_0);
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "gpr_rdata_1", snitch_trace.gpr_rdata_1);
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "gpr_rdata_2", snitch_trace.gpr_rdata_2);
    ...
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "acc_qvalid", snitch_trace.acc_qvalid);
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "acc_qaddr", snitch_trace.acc_qaddr);
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "retire_acc", snitch_trace.retire_acc);
    extras_str = $sformatf("%s'%s': 0x%0x, ", extras_str, "acc_uses_rd", snitch_trace.acc_uses_rd);
